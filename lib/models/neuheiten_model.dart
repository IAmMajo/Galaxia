  ...
  static List<NeuheitenModel> getneuheiten() {
    ...
    neuheiten.add(
      NeuheitenModel(
          ...
          genre: 'Survival',
          des: '"The Walking Dead" ist eine beliebte postapokalyptische Horrorserie, die sich in einer von Zombies (Walkern) heimgesuchten Welt abspielt. Die Handlung folgt einer Gruppe von Überlebenden, die nach einer Zombie-Apokalypse um ihr Leben kämpfen. Sie durchlaufen eine Reise voller Gefahren, Verluste und moralischer Prüfungen, während sie versuchen, eine sichere Zuflucht zu finden. Die Serie zeichnet sich durch ihre intensiven Zombie-Action-Szenen, komplexe Charakterentwicklungen und düstere Atmosphäre aus, die die Zuschauer in ihren Bann zieht.',
    ...
    neuheiten.add(
      NeuheitenModel(
          ...
          genre: 'Star Wars',
          des: '"Star Wars: The Clone Wars" ist eine animierte Science-Fiction-Serie, die im Star Wars-Universum angesiedelt ist. Die Handlung findet zwischen den Episoden II und III der Star Wars-Filmreihe statt und beleuchtet die Klonkriege, die die Galaxie erschüttern. Die Serie folgt den Abenteuern von Jedi-Rittern wie Anakin Skywalker, Obi-Wan Kenobi und Ahsoka Tano sowie den Klonkriegern, während sie gegen die Separatisten und die dunkle Seite kämpfen. "Clone Wars" bietet epische Schlachten, fesselnde Charakterentwicklungen und eine tiefe Erweiterung der Star Wars-Geschichte.',
